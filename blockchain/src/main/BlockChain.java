package main;// Block Chain should maintain only limited block nodes to satisfy the functions
...
public class BlockChain {
    ...
    private final TransactionPool currentTXPool;
    ...
    public BlockChain(Block genesisBlock) {
        ...
        this.currentTXPool = new TransactionPool();
    }
    ...
    public boolean addBlock(Block block) {
        ...
        final BlockNode newBlockNode = new BlockNode(block, UTXOPoolWithCoinBaseUTXO(txHandler.getLedger(), block), newHeight);
//        final BlockNode myBlockNode =new BlockNode(block, txHandler.getLedger().addUTXO(new UTXO(block.getCoinbase().getHash(),0),block.getCoinbase().getOutput(0)));
...
private class BlockNode {
    ...
    UTXOPool getUTXOPool() { return ledger; }
}
}